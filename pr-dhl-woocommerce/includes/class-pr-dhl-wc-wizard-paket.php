					...
					<form class="wizard" id="dhlStepsWizard">
						<aside class="wizard-content container">
							...
							<div class="wizard-step" data-title="Step 3">
								...
								<div class="wizard-description">
									<?php echo sprintf( __( 'Please configure your access towards the DHL Paket APIs by means of authentication. Your username for the DHL business customer portal. Please note the lower case and test your access data in advance at <a href="%s">here</a>.', 'dhl-for-woocommerce' ), 'https://geschaeftskunden.dhl.de/' ); ?>
								</div>
								<div class="form-group">
