...
if ( ! class_exists( 'PR_DHL_WC_Product_Paket_Editor' ) ) :
	...
	class PR_DHL_WC_Product_Editor_Paket extends PR_DHL_WC_Product_Editor {
		...
		public function __construct() {
			...
			$this->hs_code_description       = sprintf( esc_html__( 'Harmonized Tariff Schedule is a number assigned to every possible commodity that can be imported or exported from any country. For shipments to the United States, enter the full 10-digit HTSUS code — look it up at %s', 'dhl-for-woocommerce' ), 'https://hts.usitc.gov/' );
		}
